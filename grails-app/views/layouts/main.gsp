...
<head>
    ...
    <g:layoutHead/>
    <header>
        <h1>Market Application</h1>
        <nav>
            <ul>
                <li><g:link controller="product" action="index">Products</g:link></li>
                <li><g:link controller="storage" action="index">Storage</g:link></li>
                <li><g:link controller="store" action="index">Stores</g:link></li>
            </ul>
        </nav>
    </header>
</head>
        ...
        <div class="row">
            <div class="col">
                ...
                <p>Building your first Grails app? Looking to add security, or create a Single-Page-App? Check out the <a
                        href="https://guides.grails.org" target="_blank">Grails Guides</a> for step-by-step tutorials.
                </p>
